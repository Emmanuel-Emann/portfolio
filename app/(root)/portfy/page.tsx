          ...
          <div className='w-[100%] flex flex-col gap-5'>
            <div className='bg-white flex items-center text-black p-5'>
              <div className='w-[50%] flex flex-col gap-4'>
                ...
                <p className='text-xl font-medium'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Soluta excepturi placeat distinctio eligendi alias.</p>
            ...
            <div className='bg-white text-black p-5 flex-col gap-3 flex'>
              <h1 className='text-4xl font-bold'>Front-end Skills</h1>
              <div className='flex flex-col gap-5'>
                <div>
                  <h1 className='text-2xl font-semibold'>UI/UX Design</h1>
                  <p className='text-xl font-medium'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo, iure nesciunt. Sit quisquam dolorum voluptatibus perspiciatis iure recusandae quam qui! Lorem ipsum dolor, sit amet consectetur adipisicing elit. Cumque, doloremque.</p>
                </div>
                <div>
            ...
            <div className='bg-white text-black flex flex-col items-center p-4 h-[30vh]'>
              <h1 className='text-4xl font-bold'>Certificate</h1>
              <div className='w-[100%] h-[40vh] flex items-center gap-2'>
                <Image src="/certi.png" alt='certi' width={100} height={100} className='w-[50%] h-[20vh]'/>
                <Image src="/certi.png" alt='certi' width={100} height={100} className='w-[50%] h-[20vh]'/>
              </div>
            </div>
          </div>
